...
interface BaseChannelConfigProps {
  channelName: string
  channelColor: string
...
export function BaseChannelConfig({
  channelName,
  channelColor,
  fields,
  values,
  ...
  return (
    <div className="bg-card rounded-2xl p-5 border border-border">
      <div className="flex items-center gap-2 mb-4">
        ...
        >
          <Settings2 className="w-4 h-4" style={{ color: channelColor }} />
        </div>
        <h2 className="text-lg font-semibold text-foreground">Configuración {channelName}</h2>
      </div>
